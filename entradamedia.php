...
<g>
	...
	<path d="M407.04,92.7v-7.71h7.71v-7.71h7.71v-7.71h7.71v-7.71h-7.71v-7.71h-7.71v-7.71h-7.71v-7.71h15.42v7.71h7.71v7.71h7.71v7.71
        ...
        <?php
        $buscar="SELECT * FROM articulos WHERE id_articulo = 1";
        $buscar_ej= mysqli_query($conexion,$buscar);
        $articulo=mysqli_fetch_array($buscar_ej);
        ?>
        <main class="cuerpo">
            <h1 class="h1">
            <?php
            ...
            <div class="imagen-articulo">
                ...
                <img src="<?php echo $articulo['imagen_3'];?>" alt="Imagen principal">
